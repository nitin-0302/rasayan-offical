            ...
            <div className="glass-card p-8 rounded-[2.5rem]">
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
                <div>
                  ...
                  <p className="text-xs text-text-muted mt-1">Select any event below to adjust its pricing list, description rules, dynamic teams size, or coordinators info.</p>
                </div>
                <div className="text-xs text-brand-primary font-bold bg-brand-soft px-4 py-2 rounded-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-4 space-y-3 max-h-[600px] overflow-y-auto pr-2">
                  <p className="text-[10px] uppercase font-bold text-text-muted tracking-widest pl-1">List of Competitions</p>
                  {events.map((evt) => (
                    <div
                      key={evt.id}
                  ...
                  {selectedEventId && editingEventForm ? (
                    <form onSubmit={saveEventChanges} className="space-y-6 bg-gray-50/50 p-6 md:p-8 rounded-[2rem] border border-gray-200">
                      <div className="flex justify-between items-center pb-4 border-b border-gray-200">
                        ...
                        <span className="text-[10px] bg-red-100 text-red-800 font-bold px-2 py-1 rounded uppercase">{editingEventForm.category}</span>
                      </div>
